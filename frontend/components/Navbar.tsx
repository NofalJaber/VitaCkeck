...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile Side Menu */}
      <div
        className={`fixed left-0 top-0 z-40 h-full w-72 transform bg-card border-r border-border shadow-xl transition-transform duration-300 ease-in-out lg:hidden ${
